...
var author$project$Docs$Main$contentFromPage = function (page) {
	switch (page.$) {
		...
		case 'Changelog':
			var _n1 = author$project$Docs$Changelog$init;
			var changelogModel = _n1.a;
			var cmds = _n1.b;
			return _Utils_Tuple2(
...
var author$project$Docs$Main$init = F3(
	function (_n0, location, key) {
		var page = author$project$Docs$Page$nextPage(location);
		var _n1 = rundis$elm_bootstrap$Bootstrap$Navbar$initialState(author$project$Docs$Main$MenuMsg);
		var menu = _n1.a;
		var menuCmds = _n1.b;
		var _n2 = author$project$Docs$Main$contentFromPage(page);
		var content = _n2.a;
		var contentCmds = _n2.b;
		return _Utils_Tuple2(
	...
	function (msg, model) {
		switch (msg.$) {
			...
			case 'OnUrlRequest':
				...
				if (r.$ === 'Internal') {
					var u = r.a;
					var _n2 = A3(author$project$Docs$Main$init, _Utils_Tuple0, u, model.key);
					var m = _n2.a;
					var cmds = _n2.b;
					return _Utils_Tuple2(
						m,
...
var author$project$Docs$Changelog$view = function (_n0) {
	var model = _n0.a;
...
var author$project$Analyser$Checks$FunctionInLet$asMessage = function (_n0) {
	var declaration = _n0.declaration;
...
var author$project$ASTUtil$Functions$isStatic = function (_function) {
	...
	return (elm$core$List$length(decl._arguments) > 0) ? false : (A2(
		...
		A2(
			...
			_function.signature)) ? false : true);
};
...
var author$project$Analyser$Checks$SingleFieldRecord$realMatches = function (_n0) {
	var matches = _n0.matches;
	var whitelisted = _n0.whitelisted;
	return A2(
		elm$core$List$filter,
		function (m) {
...
var author$project$Analyser$Checks$UnnecessaryParens$onCaseBlock = F2(
	function (caseBlock, context) {
		var _n0 = author$project$Analyser$Checks$UnnecessaryParens$getParenthesized(caseBlock.expression);
		if (_n0.$ === 'Just') {
			var _n1 = _n0.a;
			var range = _n1.a;
...
var author$project$Analyser$Checks$UnnecessaryParens$onFunction = F2(
	function (_n0, context) {
		var _function = _n0.b;
		var _n1 = stil4m$elm_syntax$Elm$Syntax$Node$value(_function.declaration).expression;
		if (_n1.b.$ === 'ParenthesizedExpression') {
			var range = _n1.a;
			return A2(elm$core$List$cons, range, context);
		} else {
			return context;
...
var author$project$Analyser$Checks$UnnecessaryParens$onLambda = F2(
	function (lambda, context) {
		var _n0 = lambda.expression;
		if (_n0.b.$ === 'ParenthesizedExpression') {
			var range = _n0.a;
			return A2(elm$core$List$cons, range, context);
		} else {
			return context;
...
var author$project$Analyser$Checks$UnusedImportAlias$onImport = F2(
	function (_n0, context) {
		var r = _n0.a;
		var imp = _n0.b;
		var _n1 = A2(elm$core$Maybe$map, stil4m$elm_syntax$Elm$Syntax$Node$value, imp.moduleAlias);
		if (_n1.$ === 'Just') {
			var x = _n1.a;
			return A3(
				elm$core$Dict$insert,
...
var author$project$Analyser$Checks$UnusedImportedVariable$filterByModuleType = function (fileContext) {
	var _n0 = stil4m$elm_syntax$Elm$Syntax$Node$value(fileContext.ast.moduleDefinition);
	if (_n0.$ === 'EffectModule') {
...
var author$project$Analyser$Messages$Schema$viewArgument = function (_n0) {
	var name = _n0.a;
	var t = _n0.b;
	return A2(
		elm$html$Html$li,
...
var author$project$Analyser$Messages$Schema$viewSchema = function (_n0) {
	var d = _n0.a;
	return A2(
		elm$html$Html$ul,
		_List_Nil,
...
var author$project$Client$Highlight$afterHighlight = F3(
	function (rowsAround, targetRows, range) {
		var _n0 = _Utils_Tuple3(range.start.row, range.end.row, range.end.column);
		var endRow = _n0.b;
		var endColumn = _n0.c;
		var postLineText = A2(
			elm$core$Maybe$withDefault,
...
var author$project$Client$Highlight$highlightedPre = F3(
	function (rowsAround, content, range) {
		if (_Utils_eq(range, stil4m$elm_syntax$Elm$Syntax$Range$emptyRange)) {
			...
			var _n0 = _Utils_Tuple2(range.start.row, range.end.row);
			return A2(
				elm$html$Html$pre,
				_List_Nil,
				_List_fromArray(
