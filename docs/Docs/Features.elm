    ...
    Html.div []
        ...
        , Html.div [ Html.Attributes.class "row" ]
            [ Html.div [ Html.Attributes.class "col" ]
                ...
                , Html.ul []
                    [ Html.li [] [ Html.text "Split type definitions and functions operating with these into separate modules." ]
