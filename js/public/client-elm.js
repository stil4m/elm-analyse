...
var _danielnarey$elm_toolkit$Toolkit_Operators_ops = _danielnarey$elm_toolkit$Toolkit_Operators_ops || {};
_danielnarey$elm_toolkit$Toolkit_Operators_ops['!+>'] = F2(
	function (firstResult, nextFunction) {
		return A2(_elm_lang$core$Result$andThen, nextFunction, firstResult);
	});
var _danielnarey$elm_toolkit$Toolkit_Operators_ops = _danielnarey$elm_toolkit$Toolkit_Operators_ops || {};
_danielnarey$elm_toolkit$Toolkit_Operators_ops['?+>'] = F2(
	function (firstResult, nextFunction) {
		return A2(_elm_lang$core$Maybe$andThen, nextFunction, firstResult);
	});
var _danielnarey$elm_toolkit$Toolkit_Operators_ops = _danielnarey$elm_toolkit$Toolkit_Operators_ops || {};
_danielnarey$elm_toolkit$Toolkit_Operators_ops['!|>'] = F2(
	function (resultValue, f) {
		return A2(_elm_lang$core$Result$map, f, resultValue);
	});
var _danielnarey$elm_toolkit$Toolkit_Operators_ops = _danielnarey$elm_toolkit$Toolkit_Operators_ops || {};
_danielnarey$elm_toolkit$Toolkit_Operators_ops['?|>'] = F2(
	function (maybeValue, f) {
		return A2(_elm_lang$core$Maybe$map, f, maybeValue);
	});
var _danielnarey$elm_toolkit$Toolkit_Operators_ops = _danielnarey$elm_toolkit$Toolkit_Operators_ops || {};
_danielnarey$elm_toolkit$Toolkit_Operators_ops['!='] = F2(
	function (resultValue, defaultValue) {
		return A2(_elm_lang$core$Result$withDefault, defaultValue, resultValue);
	});
var _danielnarey$elm_toolkit$Toolkit_Operators_ops = _danielnarey$elm_toolkit$Toolkit_Operators_ops || {};
_danielnarey$elm_toolkit$Toolkit_Operators_ops['?='] = F2(
	function (maybeValue, defaultValue) {
		return A2(_elm_lang$core$Maybe$withDefault, defaultValue, maybeValue);
	});
var _danielnarey$elm_toolkit$Toolkit_Operators_ops = _danielnarey$elm_toolkit$Toolkit_Operators_ops || {};
_danielnarey$elm_toolkit$Toolkit_Operators_ops['@@|>'] = F2(
	function (params, f) {
...
var _danielnarey$elm_toolkit$Toolkit_Helpers$isBetween = F2(
	function (_p62, value) {
		var _p63 = _p62;
		return (_elm_lang$core$Native_Utils.cmp(value, _p63._0) > 0) && (_elm_lang$core$Native_Utils.cmp(value, _p63._1) < 0);
	});
var _danielnarey$elm_toolkit$Toolkit_Helpers$isInRange = F2(
	function (_p64, value) {
		var _p65 = _p64;
		return (_elm_lang$core$Native_Utils.cmp(value, _p65._0) > -1) && (_elm_lang$core$Native_Utils.cmp(value, _p65._1) < 1);
	});
...
var _danielnarey$elm_toolkit$Toolkit_Helpers$toBool = function (boolString) {
	var _p66 = _elm_lang$core$String$toLower(boolString);
	switch (_p66) {
		case 'true':
...
var _user$project$Client_DashBoard_State$State = F2(
	function (a, b) {
		return {loading: a, messages: b};
	});
var _user$project$Client_DashBoard_State$decodeState = A2(
	_elm_community$json_extra$Json_Decode_Extra_ops['|:'],
	A2(
		_elm_community$json_extra$Json_Decode_Extra_ops['|:'],
		_elm_lang$core$Json_Decode$succeed(_user$project$Client_DashBoard_State$State),
		A2(_elm_lang$core$Json_Decode$field, 'loading', _elm_lang$core$Json_Decode$bool)),
	A2(
		_elm_lang$core$Json_Decode$field,
		'messages',
		_elm_lang$core$Json_Decode$list(_user$project$Analyser_Messages$decodeMessage)));
			...
			return A2(
				...
				{ctor: '[]'},
				{
					...
					_0: A2(
						...
						A2(
							_elm_lang$core$List$map,
							_user$project$Client_DashBoard_ActiveMessageDialog$renderRange(_p2._0),
							state.ranges)),
					_1: {
						ctor: '::',
						_0: _elm_lang$html$Html$text(
							_user$project$Analyser_Messages$asString(state.message)),
						_1: {ctor: '[]'}
					}
				});
		default:
...
var _user$project$Client_DashBoard_ActiveMessageDialog$init = _elm_lang$core$Maybe$Nothing;
var _user$project$Client_DashBoard_ActiveMessageDialog$hide = _elm_lang$core$Basics$always(_elm_lang$core$Maybe$Nothing);
var _user$project$Client_DashBoard_ActiveMessageDialog$update = F2(
	function (msg, model) {
		var _p3 = msg;
		if (_p3.ctor === 'Close') {
			return _user$project$Client_DashBoard_ActiveMessageDialog$hide(model);
		} else {
			return A2(
				_elm_lang$core$Maybe$map,
				function (y) {
...
var _user$project$Client_DashBoard_ActiveMessageDialog$State = F3(
	function (a, b, c) {
		return {message: a, ranges: b, codeBlock: c};
	});
var _user$project$Client_DashBoard_ActiveMessageDialog$OnFile = function (a) {
	...
	function (m, _p4) {
		return {
			...
			_0: _elm_lang$core$Maybe$Just(
				{
					message: m,
					ranges: _user$project$Analyser_Messages$getRanges(m),
					codeBlock: _krisajenkins$remotedata$RemoteData$Loading
				}),
			_1: A2(
				_elm_lang$http$Http$send,
				_user$project$Client_DashBoard_ActiveMessageDialog$OnFile,
						...
						url: A2(
							...
							A2(
								...
								A2(
									...
									_user$project$Analyser_Messages$getFiles(m)))),
						body: _elm_lang$http$Http$emptyBody,
						expect: _elm_lang$http$Http$expectString,
						timeout: _elm_lang$core$Maybe$Nothing,
						withCredentials: false
...
var _user$project$Client_DashBoard_ActiveMessageDialog$Close = {ctor: 'Close'};
var _user$project$Client_DashBoard_ActiveMessageDialog$dialogConfig = function (state) {
	return {
		closeMessage: _elm_lang$core$Maybe$Just(_user$project$Client_DashBoard_ActiveMessageDialog$Close),
		containerClass: _elm_lang$core$Maybe$Just('message-dialog'),
		header: _elm_lang$core$Maybe$Just(_user$project$Client_DashBoard_ActiveMessageDialog$dialogHeader),
		body: _elm_lang$core$Maybe$Just(
			_user$project$Client_DashBoard_ActiveMessageDialog$dialogBody(state)),
		footer: _elm_lang$core$Maybe$Nothing
	};
};
var _user$project$Client_DashBoard_ActiveMessageDialog$view = function (model) {
	return _krisajenkins$elm_dialog$Dialog$view(
		A2(_elm_lang$core$Maybe$map, _user$project$Client_DashBoard_ActiveMessageDialog$dialogConfig, model));
};

var _user$project$Client_DashBoard_DashBoard$init = {
	ctor: '_Tuple2',
	_0: {messages: _krisajenkins$remotedata$RemoteData$Loading, active: _user$project$Client_DashBoard_ActiveMessageDialog$init},
	_1: _elm_lang$core$Platform_Cmd$none
};
var _user$project$Client_DashBoard_DashBoard$socketAddress = 'ws://localhost:3000/dashboard';
var _user$project$Client_DashBoard_DashBoard$Model = F2(
	function (a, b) {
		return {messages: a, active: b};
	});
var _user$project$Client_DashBoard_DashBoard$ActiveMessageDialogMsg = function (a) {
	return {ctor: 'ActiveMessageDialogMsg', _0: a};
};
var _user$project$Client_DashBoard_DashBoard$update = F2(
	function (msg, model) {
		var _p0 = msg;
		switch (_p0.ctor) {
			case 'Tick':
				return {
					ctor: '_Tuple2',
					_0: model,
					_1: A2(_elm_lang$websocket$WebSocket$send, _user$project$Client_DashBoard_DashBoard$socketAddress, 'ping')
				};
			case 'NewMsg':
				var _p1 = _p0._0;
				if (_p1.ctor === 'Ok') {
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								messages: _krisajenkins$remotedata$RemoteData$Success(_p1._0)
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				} else {
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								messages: _krisajenkins$remotedata$RemoteData$Failure(_p1._0)
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				}
			case 'Focus':
				return A2(
					...
					_elm_lang$core$Platform_Cmd$map(_user$project$Client_DashBoard_DashBoard$ActiveMessageDialogMsg),
					A2(
						...
						A2(_user$project$Client_DashBoard_ActiveMessageDialog$show, _p0._0, model.active)));
			default:
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							active: A2(_user$project$Client_DashBoard_ActiveMessageDialog$update, _p0._0, model.active)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
		}
	});
var _user$project$Client_DashBoard_DashBoard$Focus = function (a) {
	return {ctor: 'Focus', _0: a};
};
var _user$project$Client_DashBoard_DashBoard$viewMessage = F2(
	function (n, x) {
		return A2(
						...
						_0: A2(
							_elm_lang$html$Html$a,
							{
								...
								_0: _elm_lang$html$Html_Events$onClick(
									_user$project$Client_DashBoard_DashBoard$Focus(x)),
								_1: {
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$style(
										{
						...
						_1: {
							...
							_0: A2(
								...
								},
								{
									ctor: '::',
									_0: _elm_lang$html$Html$text(
										_user$project$Analyser_Messages$asString(x)),
									_1: {ctor: '[]'}
								}),
							_1: {ctor: '[]'}
						}
...
var _user$project$Client_DashBoard_DashBoard$viewState = function (state) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
			...
			_1: {
				...
				_0: A2(
					...
					A2(_elm_lang$core$List$indexedMap, _user$project$Client_DashBoard_DashBoard$viewMessage, state.messages)),
				_1: {ctor: '[]'}
			}
		});
};
		...
		},
		{
			...
			_0: function () {
				...
				switch (_p2.ctor) {
					...
					case 'Success':
						return _user$project$Client_DashBoard_DashBoard$viewState(_p2._0);
					case 'Failure':
			...
			_1: {
				...
				_0: A2(
					...
					_user$project$Client_DashBoard_DashBoard$ActiveMessageDialogMsg,
					_user$project$Client_DashBoard_ActiveMessageDialog$view(m.active)),
				_1: {ctor: '[]'}
			}
		});
};
...
var _user$project$Client_DashBoard_DashBoard$subscriptions = function (_p3) {
	return _elm_lang$core$Platform_Sub$batch(
		{
			ctor: '::',
			_0: A2(
				_elm_lang$websocket$WebSocket$listen,
				_user$project$Client_DashBoard_DashBoard$socketAddress,
				function (_p4) {
					return _user$project$Client_DashBoard_DashBoard$NewMsg(
						A2(_elm_lang$core$Json_Decode$decodeString, _user$project$Client_DashBoard_State$decodeState, _p4));
				}),
			_1: {
				ctor: '::',
				_0: A2(
...
var _user$project$Client_App_Menu$view = A2(
	_elm_lang$html$Html$nav,
	{
		ctor: '::',
		_0: _elm_lang$html$Html_Attributes$class('navbar navbar-default'),
		_1: {ctor: '[]'}
	},
	{
		ctor: '::',
...
var _user$project$Client_App_App$view = function (m) {
	return A2(
		...
		{
			ctor: '::',
			_0: _user$project$Client_App_Menu$view,
			_1: {
				ctor: '::',
				_0: function () {
					var _p0 = m;
					return A2(
						...
						_user$project$Client_DashBoard_DashBoard$view(_p0._0));
				}(),
				_1: {ctor: '[]'}
			}
		});
};
var _user$project$Client_App_App$init = A2(
	_Fresheyeball$elm_tuple_extra$Tuple2$mapSecond,
	_elm_lang$core$Platform_Cmd$map(_user$project$Client_App_Models$DashBoardMsg),
	A2(_Fresheyeball$elm_tuple_extra$Tuple2$mapFirst, _user$project$Client_App_Models$DashBoardContent, _user$project$Client_DashBoard_DashBoard$init));
var _user$project$Client_App_App$endpoint = 'ws://localhost:3000/control';
	...
	return _elm_lang$core$Platform_Sub$batch(
		{
			...
			_0: function () {
				...
				return A2(
					...
					_user$project$Client_App_Models$DashBoardMsg,
					_user$project$Client_DashBoard_DashBoard$subscriptions(_p1._0));
			}(),
			_1: {
				ctor: '::',
				_0: _elm_lang$websocket$WebSocket$keepAlive(_user$project$Client_App_App$endpoint),
				_1: {ctor: '[]'}
			}
		});
};
	...
	function (msg, model) {
		...
		if (_p2.ctor === 'Refresh') {
			return {
				ctor: '_Tuple2',
				_0: model,
				_1: A2(_elm_lang$websocket$WebSocket$send, _user$project$Client_App_App$endpoint, 'reload')
			};
		} else {
			var _p3 = model;
			return A2(
				...
				A2(
					_Fresheyeball$elm_tuple_extra$Tuple2$mapFirst,
					_user$project$Client_App_Models$DashBoardContent,
					A2(_user$project$Client_DashBoard_DashBoard$update, _p2._0, _p3._0)));
		}
	});

var _user$project$Client_Main$view = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
...
var _user$project$Client_Main$main = _elm_lang$html$Html$program(
	{init: _user$project$Client_App_App$init, view: _user$project$Client_Main$view, update: _user$project$Client_App_App$update, subscriptions: _user$project$Client_App_App$subscriptions})();

var Elm = {};
Elm['Client'] = Elm['Client'] || {};
Elm['Client']['Main'] = Elm['Client']['Main'] || {};
if (typeof _user$project$Client_Main$main !== 'undefined') {
    _user$project$Client_Main$main(Elm['Client']['Main'], 'Client.Main', undefined);
}
